  ...
  return (
    <div className='p-7 h-screen flex flex-col justify-between '>
      ...
      <div className='flex flex-col space-y-3'>
        ...
        <p className='flex justify-center'>New here?<Link to="/signup" className='text-blue-600'>Create a account </Link> </p>
      </div>
      ...
      <div className=''>
        <Link to="/captain-login" className='flex justify-center items-center py-2 w-full rounded-md bg-green-500 text-gray-800 text-lg font-semibold'>Sign in as Captain</Link>
      </div>
